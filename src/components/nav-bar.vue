...
export default {
        ...
        methods: {
                ...
                toggleDarkMode() {
                        if (document.documentElement.getAttribute("data-layout-mode") == "dark") {
                                localStorage.setItem("GURUB-data-layout-mode", "light")
                                this.$store.dispatch("layout/changeMode", {mode:'light'});

                                document.documentElement.setAttribute("data-layout-mode", "light");
                        } else {
                                localStorage.setItem("GURUB-data-layout-mode", "dark")
                                this.$store.dispatch("layout/changeMode", {mode:'dark'});
        ...
        mounted() {
                ...
                if(!localStorage.getItem("GURUB-data-layout-mode"))
                {
                    this.$store.dispatch("layout/changeMode", {mode:'light'});
                }
               if(localStorage.getItem("GURUB-data-layout-mode")) {
                    this.$store.dispatch("layout/changeMode", {mode: localStorage.getItem("GURUB-data-layout-mode")});
                    document.documentElement.setAttribute("data-layout-mode", {mode: localStorage.getItem("GURUB-data-layout-mode") || 'light'});
                }
                                        ...
                                        <form class="app-search d-none">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                                                        ...
                                                        <div class="text-center pt-3 pb-1">
                                                                <router-link to="/pages/search-results"
...
<!-- 
                                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                        <b-link href="javascript:void(0);" v-for="(entry, i) in languages"
                                                                ...
                                                                title="English">
                                                                <img :src="entry.flag" alt="user-image" class="me-2 rounded"
                                                                        height="18" />
                ...
                ">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart"
                                                                ...
                                                                <b-row class="align-items-center">
                                                                        ...
                                                                        <b-col cols="auto">
                                                                                <b-badge variant="soft-warning"
                                                                                        class="badge-soft-warning fs-13"><span
                                                        ...
                                                        <SimpleBar data-simplebar style="max-height: 300px">
                                                                <div class="p-2">
                                                                        <div class="text-center empty-cart" id="empty-cart">
                                                                                ...
                                                                                <b-link href="/ecommerce/products"
                                                                                ...
                                                                                <div class="d-flex align-items-center">
                                                                                        ...
                                                                                        <div class="flex-1">
                                                                                                <h6 class="mt-0 mb-1 fs-14">
                                                                                                        <b-link href="/ecommerce/product-details"
                                                                                        ...
                                                                                        <div class="ps-2">
                                                                                                <b-button type="button"
                                                                                                        ...
                                                                                                        size="sm"
                                                                                                        class="btn btn-icon remove-item-btn"><i
                                                        ...
                                                        <div class="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border"
                                                                ...
                                                                <div
                                                                        ...
                                                                        <div class="px-2">
                                                                                <h5 class="m-0" id="cart-item-total">$1258.58
                                                                                </h5>
                                                                        </div>
                                                                </div>

                                                                <b-link href="/ecommerce/checkout"
                                        ...
                                        <div class="ms-1 header-item d-none d-sm-flex">
                                                <b-button type="button" variant="ghost-secondary"
                                                        class="btn-icon btn-topbar rounded-circle" data-toggle="fullscreen"
                                        ...
                                        <!-- <div class="dropdown topbar-head-dropdown ms-1 header-item">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                                        ...
                                                        <div class="tab-content" id="notificationItemsTabContent">
                                                                ...
                                                                <div class="tab-pane fade py-2 ps-2 show active"
                                ...
                                <div class="dropdown ms-sm-3 header-item topbar-user">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <router-link class="dropdown-item" to="/profile"><i
                                                        ...
                                                        <span class="align-middle">Thông tin hồ sơ</span>
                                                </router-link>
                                                <router-link class="dropdown-item" to="#">
                                                        <i
                                                                class=" mdi mdi-message-text-outline text-muted fs-16 align-middle me-1"></i>
                                                        <span class="align-middle">Nhắn tin</span>
                                                </router-link>
                                                ...
                                                <router-link class="dropdown-item" to="#"><i
                                                        ...
                                                        <span class="align-middle">Hỗ trợ</span>
                                                </router-link>
