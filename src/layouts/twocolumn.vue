                    ...
                    <b-container fluid>
                        <div id="two-column-menu">
                            <SimpleBar class="twocolumn-iconview list-unstyled">
                                ...
                                <li class="nav-item" v-b-tooltip.hover.right="{ title: item.label }"
                                    v-for="(item, index) in sidebar_routes" :key="index">
                                    <div class="nav-icon fs-16 my-n3"
                                        v-if="index == 1 || index == sidebar_routes.length - 1 || index == 4 || index == 6">
                                        <i class="ri-more-fill"></i>
                                    </div>
                                    <router-link class="nav-icon" :to="item.link" :class="{
                                        'router-link-active router-link-exact-active nav-icon active': item.link == this.$route.path
                                    }">
                                        <i :class="item.icon"></i>
                                    </router-link>
                                </li>
                                <!-- <li>
                                                                        <b-link class="nav-icon" href="#sidebarForms"
                                                                                role="button"
                            ...
                            <SimpleBar class="navbar-nav" id="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <div class="collapse menu-dropdown" id="sidebarApps">
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            <li class="nav-item">
                                                <b-link href="#jobs" class="nav-link" data-bs-toggle="collapse"
                                                    role="button" aria-expanded="false" aria-controls="jobs"
                                                    data-key="t-jobs">
                                                    {{ $t("t-jobs") }}
                                                    <b-badge variant="success" class="badge-pill" data-key="t-new">{{
                                                        $t("t-new")
                                                ...
                                                <div class="collapse menu-dropdown" id="jobs">
                                                    <ul class="nav nav-sm flex-column">
                                                        ...
                                                        <li class="nav-item">
                                                            <b-link href="#sidebarjoblist" class="nav-link"
                                                                data-bs-toggle="collapse" role="button"
                                                                aria-expanded="false" aria-controls="sidebarjoblist"
                                                                data-key="t-job-list">
                                                                {{
                                                                    $t("t-job-lists")
                                                                }}
                                                                ...
                                                                <ul class="nav nav-sm flex-column">
                                                                    <li class="nav-item">
                                                                        <router-link to="/jobs/candidate-lists"
                                                                            class="nav-link" data-key="t-lists">
                                                                            {{
                                                                                $t("t-list-view")
                                                                            }}
                                                                        </router-link>
                                ...
                                <li class="nav-item">
                                    <div class="collapse menu-dropdown" id="sidebarAuth">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <b-link href="#sidebarSignIn" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <div class="collapse menu-dropdown" id="sidebarSignIn">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                                            <router-link to="/auth/signin-basic" class="nav-link"
                                                                data-key="t-basic">
                                                                {{
                                                                    $t("t-basic")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/auth/signin-cover" class="nav-link"
                                                                data-key="t-cover">
                                                                {{
                                                                    $t("t-cover")
                                                                }}
                                            ...
                                            <li class="nav-item">
                                                <b-link href="#sidebarSignUp" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <div class="collapse menu-dropdown" id="sidebarSignUp">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                                            <router-link to="/auth/signup-basic" class="nav-link"
                                                                data-key="t-basic">
                                                                {{
                                                                    $t("t-basic")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/auth/signup-cover" class="nav-link"
                                                                data-key="t-cover">
                                                                {{
                                                                    $t("t-cover")
                                                                }}
                                            ...
                                            <li class="nav-item">
                                                <b-link href="#sidebarResetPass" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <div class="collapse menu-dropdown" id="sidebarResetPass">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                                            <router-link to="/auth/reset-pwd-basic" class="nav-link"
                                                                data-key="t-basic">
                                                                {{
                                                                    $t("t-basic")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/auth/reset-pwd-cover" class="nav-link"
                                                                data-key="t-cover">
                                                                {{
                                                                    $t("t-cover")
                                                                }}
                                            ...
                                            <li class="nav-item">
                                                <b-link href="#sidebarcreatepass" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <div class="collapse menu-dropdown" id="sidebarcreatepass">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                                            <router-link to="/auth/create-pwd-basic" class="nav-link"
                                                                data-key="t-basic">
                                                                {{
                                                                    $t("t-basic")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/auth/create-pwd-cover" class="nav-link"
                                                                data-key="t-cover">
                                                                {{
                                                                    $t("t-cover")
                                                                }}
                                            ...
                                            <li class="nav-item">
                                                <b-link href="#sidebarLockScreen" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <div class="collapse menu-dropdown" id="sidebarLockScreen">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                                            <router-link to="/auth/lockscreen-basic" class="nav-link"
                                                                data-key="t-basic">
                                                                {{
                                                                    $t("t-basic")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/auth/lockscreen-cover" class="nav-link"
                                                                data-key="t-cover">
                                                                {{
                                                                    $t("t-cover")
                                                                }}
                                            ...
                                            <li class="nav-item">
                                                <b-link href="#sidebarLogout" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <div class="collapse menu-dropdown" id="sidebarLogout">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                                            <router-link to="/auth/logout-basic" class="nav-link"
                                                                data-key="t-basic">
                                                                {{
                                                                    $t("t-basic")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/auth/logout-cover" class="nav-link"
                                                                data-key="t-cover">
                                                                {{
                                                                    $t("t-cover")
                                                                }}
                                            ...
                                            <li class="nav-item">
                                                <b-link href="#sidebarSuccessMsg" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <div class="collapse menu-dropdown" id="sidebarSuccessMsg">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                                            <router-link to="/auth/success-msg-basic" class="nav-link"
                                                                data-key="t-basic">
                                                                {{
                                                                    $t("t-basic")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/auth/success-msg-cover" class="nav-link"
                                                                data-key="t-cover">
                                                                {{
                                                                    $t("t-cover")
                                                                }}
                                            ...
                                            <li class="nav-item">
                                                <b-link href="#sidebarTwoStep" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <div class="collapse menu-dropdown" id="sidebarTwoStep">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                                            <router-link to="/auth/twostep-basic" class="nav-link"
                                                                data-key="t-basic">
                                                                {{
                                                                    $t("t-basic")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/auth/twostep-cover" class="nav-link"
                                                                data-key="t-cover">
                                                                {{
                                                                    $t("t-cover")
                                                                }}
                                            ...
                                            <li class="nav-item">
                                                <b-link href="#sidebarErrors" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <div class="collapse menu-dropdown" id="sidebarErrors">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                                            <router-link to="/auth/404-basic" class="nav-link"
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/auth/404-cover" class="nav-link"
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/auth/404" class="nav-link"
                                                                data-key="t-404-alt">
                                                                {{
                                                                    $t("t-404-alt")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/auth/ofline" class="nav-link"
                                                                data-key="t-500">
                                                                {{
                                                                    $t("t-offline-page")
                                                                }}
                                ...
                                <li class="nav-item">
                                    <div class="collapse menu-dropdown" id="sidebarPages">
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            <li class="nav-item">
                                                <b-link href="#sidebarProfile" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <div class="collapse menu-dropdown" id="sidebarProfile">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                                            <router-link to="/pages/profile" class="nav-link"
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/pages/profile-setting" class="nav-link"
                                                                data-key="t-settings">
                                                                {{
                                                                    $t("t-settings")
                                                                }}
                                            ...
                                            <li class="nav-item">
                                                <router-link to="/pages/search-results" class="nav-link"
                                            ...
                                            <li class="nav-item">
                                                <router-link to="/pages/privacy-policy" class="nav-link"
                                            ...
                                            <li class="nav-item">
                                                <router-link to="/pages/term-conditions" class="nav-link"
                                        ...
                                        <b-row>
                                            ...
                                            <b-col lg="4">
                                                <ul class="nav nav-sm flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link to="/ui/offcanvas" class="nav-link"
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link to="/ui/placeholders" class="nav-link"
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link to="/ui/progress" class="nav-link"
                                                            data-key="t-progress">{{
                                                                $t("t-progress")
                                                            }}
                                                        </router-link>
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link to="/ui/notifications" class="nav-link"
                                            ...
                                            <b-col lg="4">
                                                <ul class="nav nav-sm flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link to="/ui/typography" class="nav-link"
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link to="/ui/general" class="nav-link"
                                                            data-key="t-general">{{
                                                                $t("t-general")
                                                            }}
                                                        </router-link>
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link to="/ui/utilities" class="nav-link"
                                ...
                                <li class="nav-item">
                                    <div class="collapse menu-dropdown" id="sidebarAdvanceUI">
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            <li class="nav-item">
                                                <router-link to="/advance-ui/scrollbar" class="nav-link"
                                                    data-key="t-scrollbar">
                                                    {{ $t("t-scrollbar")
                                                    }}</router-link>
                                            </li>
                                            <li class="nav-item">
                                                <router-link to="/advance-ui/animation" class="nav-link"
                                            ...
                                            <li class="nav-item">
                                                <router-link to="/advance-ui/highlight" class="nav-link"
                                                    data-key="t-highlight">
                                                    {{ $t("t-highlight")
                                                    }}</router-link>
                                            </li>
                                            <li class="nav-item">
                                                <router-link to="/advance-ui/scrollspy" class="nav-link"
                                ...
                                <li class="nav-item">
                                    <div class="collapse menu-dropdown" id="sidebarForms">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <router-link to="/form/elements" class="nav-link"
                                            ...
                                            <li class="nav-item">
                                                <router-link to="/form/checkboxs-radios" class="nav-link"
                                            ...
                                            <li class="nav-item">
                                                <router-link to="/form/range-sliders" class="nav-link"
                                            ...
                                            <li class="nav-item">
                                                <router-link to="/form/file-uploads" class="nav-link"
                                ...
                                <li class="nav-item">
                                    <div class="collapse menu-dropdown" id="sidebarCharts">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <b-link href="#sidebarApexcharts" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <div class="collapse menu-dropdown" id="sidebarApexcharts">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                                            <router-link to="/charts/apex-line" class="nav-link"
                                                                data-key="t-line">
                                                                {{
                                                                    $t("t-line")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/charts/apex-area" class="nav-link"
                                                                data-key="t-area">
                                                                {{
                                                                    $t("t-area")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/charts/apex-bar" class="nav-link"
                                                                data-key="t-bar">
                                                                {{
                                                                    $t("t-bar")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/charts/apex-pie" class="nav-link"
                                                                data-key="t-pie">
                                                                {{
                                                                    $t("t-pie")
                                                                }}
                                                        ...
                                                        <li class="nav-item">
                                                            <router-link to="/charts/apex-polararea" class="nav-link"
                                ...
                                <li class="nav-item">
                                    <div class="collapse menu-dropdown" id="sidebarIcons">
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            <li class="nav-item">
                                                <router-link to="/icons/lineawesome" class="nav-link"
                                            ...
                                            <li class="nav-item">
                                                <router-link to="/icons/crypto" class="nav-link" data-key="t-feather">{{
                                                    $t("t-crypto-svg")
                                                }}
                                                </router-link>
                                            </li>
                                ...
                                <li class="nav-item">
                                    <div class="collapse menu-dropdown" id="sidebarMultilevel">
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            <li class="nav-item">
                                                <b-link href="#sidebarAccount" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <div class="collapse menu-dropdown" id="sidebarAccount">
                                                    <ul class="nav nav-sm flex-column">
                                                        ...
                                                        <li class="nav-item">
                                                            <b-link href="#sidebarCrm" class="nav-link"
                                                                data-bs-toggle="collapse" role="button"
